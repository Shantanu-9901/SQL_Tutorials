---Date 12/12/2020  SQL Learning  Introduction to SQL
...
---Creating child table with foreign key refrence.
...
---Creating triggers for primary key.
...
select rowid, a.* from employees a for update;
...
---To check Tablespace of the table.
